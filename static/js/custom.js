...
$(document).ready(function () {
    ...
    $('.sscroll').slimScroll({wheelStep: 1, opacity: 0.3, start: 'bottom'});
    //$('.sscroll').scrollTop($('.sscroll').height())
    //$('.padd').animate({ scrollTop: $('.padd').attr('scrollHeight') }, 300);
...
/*function loadLog() {
 var oldscrollHeight = $(".sscroll").attr("scrollHeight") - 200; //La altura del scroll antes de la petición
 $.ajax({
 url: "practica.html",
 cache: false,
 success: function (html) {
 $(".sscroll").html(html); //Inserta el log de char en el div #chatbox
 //Auto-scroll
 var newscrollHeight = $(".sscroll").attr("scrollHeight") - 200; //La altura del scroll después del pedido
 if (newscrollHeight > oldscrollHeight) {
 $(".sscroll").animate({ scrollTop: newscrollHeight }, 'normal'); //Autoscroll hacia el fondo del div
 }
 }
 });
 }*/
